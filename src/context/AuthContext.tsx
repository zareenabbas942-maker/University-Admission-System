...
// Railway backend URL fallback ke saath
const API_BASE = (import.meta.env.VITE_API_BASE_URL || 'https://university-admission-system-production.up.railway.app').replace(/\/$/, '');
